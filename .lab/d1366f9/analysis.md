...
- Recent 5 runs:
  ...
  - [discard] bpb=1.6373 | exp_068: GELU² activation — +0.016 BPB, Gaussian gating kills negative gradient flow vs LeakyReLU(0.5)²
...
## Metrics
Per-step metrics: `.lab/d1366f9/metrics.jsonl`
